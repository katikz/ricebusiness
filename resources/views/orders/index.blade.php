    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('orders.create') }}" class="px-4 py-2 bg-indigo-800 text-white rounded-md hover:bg-indigo-900">
                    Create New Order
                </a>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">{{ $order->rice->name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">{{ $order->quantity }} kg</td>
